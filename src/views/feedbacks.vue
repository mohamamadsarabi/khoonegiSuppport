<template>
	<div class="py-4 container-fluid feedbacks">
		<div class="row">
			<div class="col-12">
				<div class="card feedback-card py-2 px-4">
                  ...
                  <span class="statusClass">
                    ...
                    >
							...
							<template v-slot:details="item">
								<button
                    :style="item.value.haveMessage == false ? 'user-select: none;opacity: 0.3;pointer-events: none;' : 'user-select: unset;opacity: 1;pointer-events: unset;'"
									@click="
										$router.push(
					...
					<div v-else-if="windowWith <= 768" class="table-info-mobile">
                        ...
                        :style="item.haveMessage === false ? 'user-select: none;opacity: 0.3;pointer-events: none;' : 'user-select: unset;opacity: 1;pointer-events: unset;'"
											@click="
												$router.push(
